...
class dos(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(dos, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.deed.of.sale', 'glimsol.deed.of.sale', 'addons/glimsol_check/report/deed_of_sale.rml', parser=dos)
